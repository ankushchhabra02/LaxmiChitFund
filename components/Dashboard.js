...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      {/* Same as */}
      <ToastContainer />{" "}
      <div className="min-h-[86vh] flex items-center justify-center px-4">
        <div className="w-full max-w-2xl bg-white/5 backdrop-blur-md rounded-xl p-6 shadow-2xl border border-white/10">
          ...
          <form className="max-w-2xl mx-auto" action={handleSubmit}>
            ...
            <div className="text-right mb-4">
              ...
              >
                {showSecrets
                  ? "🙈 Hide Razorpay Details"
                  : "👁 Show Razorpay Details"}
              </button>
            </div>
            {/* Submit Button  */}
            <div className="my-6">
